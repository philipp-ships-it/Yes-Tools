...
void main() {
  ...
  vec3 fgBase = u_colorFront.rgb;
  float fgOpacity = u_colorFront.a;
  vec3 bgColor = u_colorBack.rgb * u_colorBack.a;
  float bgOpacity = u_colorBack.a;
  
  // Retro synthwave multi-color gradient
  vec3 color1 = vec3(1.0, 0.0, 0.53); // #ff0088
  vec3 color2 = vec3(0.0, 0.9, 1.0);  // #00e5ff
  vec3 color3 = vec3(0.41, 0.15, 0.98); // #6927FA
  
  vec3 dynamicColor = mix(color1, color3, sin(uv.x * 3.0 + t) * 0.5 + 0.5);
  dynamicColor = mix(dynamicColor, color2, cos(uv.y * 3.0 - t * 1.5) * 0.5 + 0.5);
  
  vec3 fgColor = dynamicColor * fgOpacity;
